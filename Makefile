#############################################################################
# Makefile for building: goo
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Sep 22 16:56:36 2014
# Project:  goo.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile goo.pro
#############################################################################
...
SOURCES       = main.cpp \
		...
		controller.cpp \
		simulation.cpp \
		simparameters.cpp moc_mainwindow.cpp \
		moc_glpanel.cpp \
		moc_controller.cpp
OBJECTS       = main.o \
		mainwindow.o \
...
Makefile: goo.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile goo.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/goo1.0.0 || $(MKDIR) .tmp/goo1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/goo1.0.0/ && $(COPY_FILE) --parents mainwindow.h glpanel.h controller.h simulation.h simparameters.h .tmp/goo1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp glpanel.cpp controller.cpp simulation.cpp simparameters.cpp .tmp/goo1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/goo1.0.0/ && (cd `dirname .tmp/goo1.0.0` && $(TAR) goo1.0.0.tar goo1.0.0 && $(COMPRESS) goo1.0.0.tar) && $(MOVE) `dirname .tmp/goo1.0.0`/goo1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/goo1.0.0
